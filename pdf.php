			...
			for ($i=0; $i < $totalLinhas ; $i++) { 
				...
				for ($numColumn=1; $numColumn < $coluna ; $numColumn++) { 
					...
					if($contar>0){
						...
						if (isset($evolucaoProntuario)) {
							if ($numDia == $evolucaoProntuario) {
								if ($horaAtendimento == $evolucaoProntuarioHora) {
									echo '<div class="row" style="padding: 5px;">
									<div class="col-xs-1 horario text-center" style="background-color: #085085; color: white">'.$evolucaoProntuarioHora.'</div>
									<div class="col-xs-11">Evolução de Prontuário</div>
									</div>'; goto end;
								}
							}
						}

						if (isset($diaAvaliacao3)) {
							if ($numDia == $diaAvaliacao3) {
								if ($horaAtendimento == $horaAvalicao3) {
									echo '<div class="row" style="padding: 5px;">
									<div class="col-xs-1 horario text-center" style="background-color: #085085; color: white">'.$horaAvalicao3.'</div>
						...
						if (isset($diaAvaliacao2)) {
							if ($numDia == $diaAvaliacao2) {
								if ($horaAtendimento == $horaAvalicao2) {
									...
									<div class="col-xs-11">'.$nomeAvaliacao.'</div>
									</div>'; goto end;
								}
							}
						}
